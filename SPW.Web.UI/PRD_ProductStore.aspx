<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="PRD_ProductStore.aspx.vb" Inherits="SPW.Web.UI.PRD_ProductStore" EnableEventValidation="false" %>
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row" style="overflow-x:auto;overflow-y:hidden;">
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <%
                                                                Dim lc As New List(Of SD02GODN)
                                                                If hddReloadGrid.Value <> String.Empty Then
                                                                    If GetDataProductStore() IsNot Nothing Then
                                                                        lc = GetDataProductStore()
                                                            %>
                                                            <table id="grdView" class="table table-striped table-bordered table-hover" style="width: 100%">
                                                                ...
                                                                <tbody>
                                                                    <%
                        Dim i As Integer = 0
                        For Each sublc As SD02GODN In lc
                            Dim strb As New StringBuilder()
                                                                    %>
                                                                    <tr>
                                                                        <%
                                                                            strb.Append("<td style='width:1%;text-align: center;'><a id='btnEditTemp' class='btn btn-info glyph-icon icon-edit'  href='javascript:CallEditData(&#39;" + IIf(sublc.FGDCODE <> String.Empty, sublc.FGDCODE, String.Empty) + "&#39;);'></a></td>")
                                                                            Dim arr As String = hddCheckUsedMaster.Value
                                                                            If arr.IndexOf(sublc.FGDCODE) = -1 Then
                                                                                strb.Append("<td style='width:1%;text-align: center;'><a id='btnDeleteTemp' class='btn btn-danger glyph-icon icon-trash' href='javascript:ConfirmDelete(&#39;" + IIf(sublc.FGDCODE <> String.Empty, sublc.FGDCODE, String.Empty) + "&#39;);'></a></td>")
                                                                            Else
                                                                                strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            End If
                                                                            strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            strb.Append("<td style='width:20%;'>" + IIf(sublc.FGDCODE <> String.Empty, sublc.FGDCODE, String.Empty) + "</td>")
                                                                            strb.Append("<td style='width:57%;'>" + IIf(sublc.FDESC <> String.Empty, sublc.FDESC, String.Empty) + "</td>")
                                                                            strb.Append("<td style='width:20%;'>" + IIf(sublc.FSHDESC <> String.Empty, sublc.FSHDESC, String.Empty) + "</td>")
                                                        ...
                                                        <div class="row">
                                                            <div class="panel panel-primary">
                                                                ...
                                                                <div class="panel-body <%=IIf((hddKeyID.Value = String.Empty And Me.GetPermission.isAdd) Or (hddKeyID.Value <> String.Empty And Me.GetPermission.isEdit), "", "disabled") %>">
                                                                    <div class="row <%=If(hddKeyID.Value = "", "hidden", "")%>">
                                                                        ...
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaCode" autocomplete="off" runat="server" CssClass="form-control" MaxLength="2"></asp:TextBox>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-2 col-md-12 col-sm-12">
                                                                            <asp:Label ID="lblaName" runat="server"></asp:Label><asp:Label ID="Label3" runat="server" Text="*" ForeColor="red"></asp:Label>
                                                                        </div>
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaName" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="30" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipName") %>'></asp:TextBox>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-2 col-md-12 col-sm-12">
                                                                            <asp:Label ID="lblaShotName" runat="server"></asp:Label>
                                                                        </div>
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaShotName" autocomplete="off" runat="server" CssClass="form-control" MaxLength="12"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
    ...
    <script type="text/javascript">
        ...
        function CheckData() {
           <%-- if ($('#<%=txtaCode.ClientID%>').val().replace(" ", "") == "") {
            ...
            if ($('#<%=txtaName.ClientID%>').val().replace(" ", "") == "") {
                $('#<%=txtaName.ClientID%>').addClass("parsley-error")
                document.getElementById('ContentPlaceHolder1_lblMassage2').style.display = "";
                scrollAndFocus('#<%=txtaName.ClientID%>');
                return;
            } else {
                $('#<%=txtaName.ClientID%>').removeClass("parsley-error")
