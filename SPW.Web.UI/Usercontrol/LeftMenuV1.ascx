<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="LeftMenuV1.ascx.vb" Inherits="SPW.Web.UI.LeftMenuV1" %>
   ...
   <div id="page-sidebar">
                    ...
                    End If
                            ...
                            <li class="<% Response.Write(IIf(oBasePage.GetCurrentWebModulePage = CStr(oModule), "Tests", ""))%>">
                                <%
                                        Response.Write("<a href='#' class='tooltip-button' data-toggle='tooltip' data-placement='right' data-original-title='" & IIf(oBasePage.WebCulture.ToUpper = "TH", possibleMeoduleNameLists.ModuleNameLC.ToString(), possibleMeoduleNameLists.ModuleNameLC.ToString()) & "'><span>" & IIf(possibleMeoduleNameLists.ModuleNameLC.ToString().Length > 25, Left(possibleMeoduleNameLists.ModuleNameLC.ToString(), 20) & "...", possibleMeoduleNameLists.ModuleNameLC.ToString()) & "</span><i class='" & possibleMeoduleNameLists.MenuIcon & "'></i></a>")
                                    Else
                                        Dim possibleMeoduleNameLists As MasterMenu_ViewModel = oModuleList.Where(Function(s) s.ModuleID = oModule And s.ModuleID IsNot Nothing).FirstOrDefault
                                            ...
                                            <li>
                                                <%
                                                    If oMasterMenu.MenuLocation = "#" Then
                                                        Response.Write("<a href='#' class='nogyp tooltip-button' style='margin-left:5px;' data-toggle='tooltip' data-placement='right' data-original-title='" & IIf(oBasePage.WebCulture.ToUpper = "TH", oMasterMenu.MenuNameLC.ToString(), oMasterMenu.MenuNameEN.ToString()) & "'>")
                                                    Else
                                                        If oBasePage.WebCulture.ToUpper = "TH" Then
                                                            'If oMasterMenu.MenuNameLC.ToString.Length > 29 Then
                                                            Response.Write("<a href='" & oMasterMenu.MenuLocation & "' class='groupSideBar tooltip-button' style='margin-left:10px;' data-toggle='tooltip' data-placement='right' data-original-title='" & IIf(oBasePage.WebCulture.ToUpper = "TH", oMasterMenu.MenuNameLC.ToString(), oMasterMenu.MenuNameEN.ToString()) & "'>")
                                                            'Else
                                                        ...
                                                        <li>
                                                            <%
                                                                If oParentMenu.MenuLocation = "#" Then
                                                                    Response.Write("<a href='#' style='margin-left:10px;' class='tooltip-button' data-toggle='tooltip' data-placement='right' data-original-title='" & IIf(oBasePage.WebCulture.ToUpper = "TH", oParentMenu.MenuNameLC.ToString(), oParentMenu.MenuNameEN.ToString()) & "'>")
                                                                    ...
                                                                    <li>
                                                                        <%
                                                                            ...
                                                                            If oBasePage.WebCulture.ToUpper = "TH" Then
                                                                                ...
                                                                                Response.Write("<a href='" & oParentMenu2.MenuLocation & "' class='groupSideBar tooltip-button' style='margin-left:20px;' data-toggle='tooltip' data-placement='right' data-original-title='" & IIf(oBasePage.WebCulture.ToUpper = "TH", oParentMenu2.MenuNameLC.ToString(), oParentMenu2.MenuNameEN.ToString()) & "'>")
                                                                                'Else
                                                            ...
                                                            Else
                                                                If oBasePage.WebCulture.ToUpper = "TH" Then
                                                                    ...
                                                                    Response.Write("<a href='" & oParentMenu.MenuLocation & "' class='groupSideBar tooltip-button' style='margin-left:10px;' data-toggle='tooltip' data-placement='right' data-original-title='" & IIf(oBasePage.WebCulture.ToUpper = "TH", oParentMenu.MenuNameLC.ToString(), oParentMenu.MenuNameEN.ToString()) & "'>")
                                                                    'Else
                                ...
                                <%
                                            Response.Write("<hr style='margin-top:0px;margin-bottom:0px;'/>")
                                            'Response.Write("<hr style='margin-top:0px;margin-bottom:0px;'/>")
