                                                                                ...
                                                                                <ContentTemplate>
                                                                                    <asp:GridView ID="grdView2" runat="server" CssClass="table table-hover table-striped table-bordered table-responsive"
                                                                                        ...
                                                                                        <Columns>
                                                                                            ...
                                                                                            <%-- <asp:TemplateField>
                                                                                                <HeaderTemplate>
                                                                                                    <%# GetWebMessage("gLeft", "Text", hddParameterMenuID.Value)%>
                                                                                                </HeaderTemplate>
                                                                                                <ItemTemplate>
                                                                                            ...
                                                                                            <asp:TemplateField>
                                                                                                <HeaderTemplate>
                                                                                                    <%# GetWebMessage("gRight", "Text", hddParameterMenuID.Value)%>
                                                                                                </HeaderTemplate>
                                                                                                <ItemTemplate>
                                                                                            ...
                                                                                            <asp:TemplateField>
                                                                                                <HeaderTemplate>
                                                                                                    <%# GetWebMessage("gStatus", "Text", hddParameterMenuID.Value)%>
                                                                                                </HeaderTemplate>
                                                                                                <ItemTemplate>
