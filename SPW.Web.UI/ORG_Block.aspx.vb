        ...
        Try
            ...
            If lst IsNot Nothing Then
                If lst.Count > 0 Then
                    ...
                    ScriptManager.RegisterStartupScript(Me, Me.GetType, "callScriptFunction", "OpenDialogError('" & GetResource("msg_block_already", "MSG") & "');", True)
                    Exit Sub
                End If
            Else
                txtaBlock.Text = String.Empty
...
#Region "LoadData"
    ...
    Public Sub LoadInit()
        ...
        lblBodydelete.Text = Me.GetResource("msg_body_delete", "MSG")
