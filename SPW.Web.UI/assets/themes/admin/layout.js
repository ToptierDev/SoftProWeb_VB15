...
$(document).ready(function() {
    ...
    $(function() {
        ...
        if (path !== undefined) {
            ...
            var item1 = $("div.Openmenu");
            $("#sidebar-menu").find(item1).css("display", "block");

            var item2 = $("li.Tests");
            $("#sidebar-menu").find(item2).addClass('sfHover');
            var menus = $('#sidebar-menu').attr('id');
            if (menus != undefined) { OpenModuleSpecial(); }
