...
Public Class TRN_SaleTargetBySalesman
    Inherits BasePage

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Not IsPostBack Then
                hddParameterMenuID.Value = HelperLog.LoadMenuID("TRN_SaleTargetBySalesman.aspx")
...
#Region "Dropdownlist"
    ...
    Public Sub LoadSalesman(ByVal ddl As DropDownList,
                           ...
                           ByVal strType As String)
        Dim bl As cSalesTargetBySalesman = New cSalesTargetBySalesman
        ddl.Items.Clear()
        Try
            If strType = "A" Then
                ddl.Items.Insert(0, New ListItem(GetResource("msg_select_all", "MSG"), ""))
...
#Region "Loaddata"
    ...
    Public Sub Loaddata()
        Try
            ...
            Dim bl As cSalesTargetBySalesman = New cSalesTargetBySalesman
            Dim lcSalesMan As List(Of LD422TSC) = bl.Loaddata(strProject,
                                                              strSalesMan,
                                                              txtsYear.Text)
            If lcSalesMan IsNot Nothing Then
                If lcSalesMan.Count > 0 Then
                    For Each sublcSalesMan As LD422TSC In lcSalesMan
