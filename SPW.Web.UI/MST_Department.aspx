                                                                                                ...
                                                                                                <ContentTemplate>
                                                                                                    <asp:GridView ID="grdView2" runat="server" CssClass="table table-hover table-striped table-bordered table-responsive"
                                                                                                        ...
                                                                                                        <Columns>
                                                                                                            <asp:TemplateField>
                                                                                                                <HeaderTemplate>
                                                                                                                    <%# GetWebMessage("gSectionCode", "Text", hddParameterMenuID.Value)%>
                                                                                                                </HeaderTemplate>
                                                                                                                <ItemTemplate>
                                                                                                            ...
                                                                                                            <asp:TemplateField>
                                                                                                                <HeaderTemplate>
                                                                                                                    <%# GetWebMessage("gName", "Text", hddParameterMenuID.Value)%>
                                                                                                                </HeaderTemplate>
                                                                                                                <ItemTemplate>
                                                                                                            ...
                                                                                                            <asp:TemplateField>
                                                                                                                <HeaderTemplate>
                                                                                                                    <%# GetWebMessage("gManager", "Text", hddParameterMenuID.Value)%>
                                                                                                                </HeaderTemplate>
                                                                                                                <ItemTemplate>
