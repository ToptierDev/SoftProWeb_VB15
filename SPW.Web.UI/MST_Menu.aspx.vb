...
#Region "Loaddata"
    ...
    Protected Sub LoadInit()
        Try
            ...
            lblBodydelete.Text = Me.GetResource("msg_body_delete", "MSG", "1") & " " & Me.GetResource("MenuID", "Text", hddParameterMenuID.Value)
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSave.Click
        Try
            ...
            Else
                ...
                Else
                    Call OpenDialog()
                    ScriptManager.RegisterStartupScript(Me, Me.GetType, "callScriptFunction", "OpenDialogError('" & GetResource("msg_duplicate", "MSG", "1") & "');", True)
                End If
            End If
        Catch ex As Exception
