<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UTL_ForgotPassword.aspx.vb" Inherits="SPW.Web.UI.UTL_ForgotPassword" %>
...
<head runat="server">
    ...
    <title>Soft Pro Web Forgot Password</title>
            ...
            <form id="from1" runat="server" class="col-md-4 col-sm-5 col-xs-11 col-lg-4 center-margin">
                        ...
                        <div id="login-form" class="content-box bg-default">
                            <div class="content-box-wrapper pad20A">
                                ...
                                <div class="form-group">
                                    <asp:Button ID="btnRequestForReset" runat="server" Text="Request for Reset password"
