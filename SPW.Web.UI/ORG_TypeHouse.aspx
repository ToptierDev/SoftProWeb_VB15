<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ORG_TypeHouse.aspx.vb" Inherits="SPW.Web.UI.ORG_TypeHouse" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                            ...
                                            <div class="panel panel-primary">
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-1 col-md-1 col-sm-1" style="text-align: right;">
                                                            <a id="btnhrefAdd" runat="server" href="javascript:CallAddData();" class="btn btn-info glyph-icon icon-plus tooltip-button" Visible='<%#Me.GetPermission().isAdd %>'>
                                                ...
                                                <div class="panel-body">
                                                    <div class="row" style="overflow-x:auto;overflow-y:hidden;">
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <%
                                                                Dim lc As New List(Of vw_TypeHouse_Join)
                                                                If hddReloadGrid.Value <> String.Empty Then
                                                                    If GetDataTypeHouse() IsNot Nothing Then
                                                                        lc = GetDataTypeHouse()
                                                            %>
                                                            <table id="grdView" class="table table-striped table-bordered table-hover" style="width: 100%">
                                                                ...
                                                                <tbody>
                                                                    <%
                        Dim i As Integer = 0
                        For Each sublc As vw_TypeHouse_Join In lc
                            Dim strb As New StringBuilder()
                                                                    %>
                                                                    <tr>
                                                                        <%
                                                                            strb.Append("<td style='width:1%;text-align: center;'><a id='btnEditTemp' class='btn btn-info glyph-icon icon-edit'  href='javascript:CallEditData(&#39;" + IIf(sublc.FTYCODE <> String.Empty, sublc.FTYCODE, String.Empty) + "&#39;);'></a></td>")
                                                                            If sublc.e_FTYCODE = String.Empty Then
                                                                                strb.Append("<td style='width:1%;text-align: center;'><a id='btnDeleteTemp' class='btn btn-danger glyph-icon icon-trash' href='javascript:ConfirmDelete(&#39;" + IIf(sublc.FTYCODE <> String.Empty, sublc.FTYCODE, String.Empty) + "&#39;);'></a></td>")
                                                                            Else
                                                                                strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            End If
                                                                            strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            strb.Append("<td style='width:20%;'>" + IIf(sublc.FTYCODE <> String.Empty, sublc.FTYCODE, String.Empty) + "</td>")
                                                                            strb.Append("<td style='width:30%;'>" + IIf(sublc.FDESC <> String.Empty, sublc.FDESC, String.Empty) + "</td>")
                                                                    ...
                                                                    <table style="width: 100%;">
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: right;">
                                                                                ...
                                                                                <a id="btnhrefSave" runat="server" href="javascript:CheckData();" class="btn glyph-icon icon-save btn-info tooltip-button">
                                                                                  
                                                                                </a>
                                                                                <%End if %>
                                                                                <a id="btnhrefCancel" runat="server" href="javascript:CallCancel();" class="btn glyph-icon icon-close btn-danger tooltip-button">
                                                                ...
                                                                <div class="panel-body <%=IIf((hddKeyID.Value = String.Empty And Me.GetPermission.isAdd) Or (hddKeyID.Value <> String.Empty And Me.GetPermission.isEdit), "", "disabled") %>">
                                                                    <div class="row">
                                                                        <div class="col-lg-1 col-md-12 col-sm-12">
                                                                            <asp:Label ID="lblaTypeCode" runat="server"></asp:Label><asp:Label ID="Label2" runat="server" Text="*" ForeColor="red"></asp:Label>
                                                                        </div>
                                                                        <div class="col-lg-4 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaTypeCode" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="6" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipTypeCode") %>'></asp:TextBox>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-1 col-md-12 col-sm-12">
                                                                            <asp:Label ID="lblaTypeName" runat="server"></asp:Label><asp:Label ID="Label3" runat="server" Text="*" ForeColor="red"></asp:Label>
                                                                        </div>
                                                                        <div class="col-lg-4 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaTypeName" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="100" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipTypeName") %>'></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function CheckData() {
            if ($('#<%=txtaTypeCode.ClientID%>').val().replace(" ", "") == "") {
                $('#<%=txtaTypeCode.ClientID%>').addClass("parsley-error")
                document.getElementById('ContentPlaceHolder1_lblMassage1').style.display = "";
                scrollAndFocus('#<%=txtaTypeCode.ClientID%>');
                return;
            } else {
                $('#<%=txtaTypeCode.ClientID%>').removeClass("parsley-error")
                document.getElementById('ContentPlaceHolder1_lblMassage1').style.display = "none";
            }
            if ($('#<%=txtaTypeName.ClientID%>').val().replace(" ", "") == "") {
                $('#<%=txtaTypeName.ClientID%>').addClass("parsley-error")
                document.getElementById('ContentPlaceHolder1_lblMassage2').style.display = "";
                scrollAndFocus('#<%=txtaTypeName.ClientID%>');
                return;
            } else {
                $('#<%=txtaTypeName.ClientID%>').removeClass("parsley-error")
