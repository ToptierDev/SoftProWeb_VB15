<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="ORG_CreateType.aspx.vb" Inherits="SPW.Web.UI.ORG_CreateType" EnableEventValidation="false" %>
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row" style="overflow-x:auto;overflow-y:hidden;">
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <%
                                                                Dim lc As New List(Of ZTypeHouseCon)
                                                                If hddReloadGrid.Value <> String.Empty Then
                                                                    If GetDataZTypeHouseCon() IsNot Nothing Then
                                                                        lc = GetDataZTypeHouseCon()
                                                            %>
                                                            <table id="grdView" class="table table-striped table-bordered table-hover" style="width: 100%">
                                                                ...
                                                                <tbody>
                                                                    <%
                        Dim i As Integer = 0
                        For Each sublc As ZTypeHouseCon In lc
                            Dim strb As New StringBuilder()
                                                                    %>
                                                                    <tr>
                                                                        <%
                                                                            strb.Append("<td style='width:1%;text-align: center;'><a id='btnEditTemp' class='btn btn-info glyph-icon icon-edit'  href='javascript:CallEditData(&#39;" + IIf(sublc.TypeHouseConsCode <> String.Empty, sublc.TypeHouseConsCode, String.Empty) + "&#39;);'></a></td>")
                                                                            Dim arr As String = hddCheckUsedMaster.Value
                                                                            If arr.IndexOf(sublc.TypeHouseConsCode) = -1 Then
                                                                                strb.Append("<td style='width:1%;text-align: center;'><a id='btnDeleteTemp' class='btn btn-danger glyph-icon icon-trash' href='javascript:ConfirmDelete(&#39;" + IIf(sublc.TypeHouseConsCode <> String.Empty, sublc.TypeHouseConsCode, String.Empty) + "&#39;);'></a></td>")
                                                                            Else
                                                                                strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            End If
                                                                            strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            strb.Append("<td style='width:20%;'>" + IIf(sublc.TypeHouseConsCode <> String.Empty, sublc.TypeHouseConsCode, String.Empty) + "</td>")
                                                                            strb.Append("<td style='width:77%;'>" + IIf(sublc.TypeHouseConsDesc <> String.Empty, sublc.TypeHouseConsDesc, String.Empty) + "</td>")
                                                                ...
                                                                <div class="panel-body <%=IIf((hddKeyID.Value = String.Empty And Me.GetPermission.isAdd) Or (hddKeyID.Value <> String.Empty And Me.GetPermission.isEdit), "", "disabled") %>">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaCode" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="10" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipCode") %>'></asp:TextBox>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaName" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="100" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipName") %>'></asp:TextBox>
