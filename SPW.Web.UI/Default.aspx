<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Default.aspx.vb" Inherits="SPW.Web.UI._Default" EnableEventValidation="false" %>
...
<body>
    ...
    <div class="center-vertical">
        <div class="center-content row">
            <form id="from1" runat="server" class="col-md-4 col-sm-5 col-xs-11 col-lg-4 center-margin" autocomplete="off">
                <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="86400"></asp:ScriptManager>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <asp:TextBox ID="txtaUserName" autocomplete="off" runat="server" class="form-control"
                                                        onkeypress="return removespacial(this, event);" placeholder="Enter User ID" onblur="CallReload();" MaxLength="10"></asp:TextBox>
                    ...
                    <ContentTemplate>
                        <asp:Panel runat="server" ID="panLogin" DefaultButton="btnLoginTemp">
                                    <table style="width:100%">
                                    <tr>
                                        <td style="vertical-align: top;width:25%">
                                    ...
                                    <tr>
                                        <td style="vertical-align: top;width:25%">
                                            <asp:Label ID="lblsCompany" runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <div class="input-group">
                                ...
                                <table style="width:100%">
                                    <tr>
                                        <td style="vertical-align: top;width:25%">
                                            <asp:Label ID="lblsLanguage" runat="server"></asp:Label>
                                        </td>
                                        <td>
                                            <div class="form-group">
                                                <div class="input-group">
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="text-align: right;">
                                                    <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="#3333CC" NavigateUrl="~/UTL_ForgotPassword.aspx?pFlag=ForgotPassword"><u>Forget</u></asp:HyperLink>&nbsp;
                                                
                                                    <asp:HyperLink ID="hplRegister" runat="server" ForeColor="#3333CC" NavigateUrl="~/MST_UserInformation.aspx?pFlag=register"><u>Register</u></asp:HyperLink>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                ...
                <script type="text/javascript">
                    ...
                    function SetInitial() {
                        $('#ddlsCompany').on('change', function () {
                            console.log();
                            if (!(this.value == '01' || this.value == '')) {
                    ...
                    function CheckData() {
                        document.getElementById('lblMassage5').style.display = "none";
                    ...
                    function OpenDialogText() {
                        ...
                        //    layout: 'bottom'
                        //});
                        document.getElementById('lblMassage5').style.display = "";
                    }
