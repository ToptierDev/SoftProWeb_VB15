<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="MST_Zone.aspx.vb" Inherits="SPW.Web.UI.MST_Zone" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row"style="overflow-x:auto;overflow-y:hidden;">
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <%
                                                                Dim lcZone As New List(Of LD07SLRT)
                                                            ...
                                                            <table id="grdView" class="table table-striped table-bordered table-hover" style="width: 100%">
                                                                ...
                                                                <tbody>
                                                                    <%
                        Dim i As Integer = 0
                        For Each sublcZone As LD07SLRT In lcZone
                            Dim strb As New StringBuilder()
                                                                    %>
                                                                    <tr>
                                                                        <%
                                                                            strb.Append("<td style='width:1%;text-align: center;'><a id='btnEditTemp' class='btn btn-info glyph-icon icon-edit'  href='javascript:CallEditData(&#39;" + IIf(sublcZone.FSLROUTE <> String.Empty, sublcZone.FSLROUTE, String.Empty) + "&#39;);'></a></td>")
                                                                            Dim arr As String = hddCheckUsedMaster.Value
                                                                            If arr.IndexOf(sublcZone.FSLROUTE) = -1 Then
                                                                                strb.Append("<td style='width:1%;text-align: center;'><a id='btnDeleteTemp' class='btn btn-danger glyph-icon icon-trash' href='javascript:ConfirmDelete(&#39;" + IIf(sublcZone.FSLROUTE <> String.Empty, sublcZone.FSLROUTE, String.Empty) + "&#39;);'></a></td>")
                                                                            Else
                                                                                strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            End If
                                                                            strb.Append("<td style='width:1%;text-align: center;'></td>")
                                                                            strb.Append("<td style='width:20%;'>" + IIf(sublcZone.FSLROUTE <> String.Empty, sublcZone.FSLROUTE, String.Empty) + "</td>")
                                                                            strb.Append("<td style='width:20%;'>" + IIf(sublcZone.FSLAREA <> String.Empty, sublcZone.FSLAREA, String.Empty) + "</td>")
                                                                            strb.Append("<td style='width:57%;'>" + IIf(sublcZone.FSLROUTENM <> String.Empty, sublcZone.FSLROUTENM, String.Empty) + "</td>")
                                                                ...
                                                                <div class="panel-body <%=IIf((hddKeyID.Value = String.Empty And Me.GetPermission.isAdd) Or (hddKeyID.Value <> String.Empty And Me.GetPermission.isEdit), "", "disabled") %>">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaZoneCode" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="4" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipZoneCode") %>'></asp:TextBox>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-2 col-md-12 col-sm-12">
                                                                            <asp:Label ID="lblaArea" runat="server"></asp:Label><asp:Label ID="Label4" runat="server" Text="*" ForeColor="red"></asp:Label>
                                                                        </div>
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaArea" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="2" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipArea") %>'></asp:TextBox>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-2 col-md-12 col-sm-12">
                                                                            <asp:Label ID="lblaZoneName" runat="server"></asp:Label><asp:Label ID="Label3" runat="server" Text="*" ForeColor="red"></asp:Label>
                                                                        </div>
                                                                        <div class="col-lg-5 col-md-12 col-sm-12" style="text-align: left;">
                                                                            <asp:TextBox ID="txtaZoneName" autocomplete="off" runat="server" CssClass="form-control tooltip-button" MaxLength="40" data-toggle="tooltip" data-placement="right" data-original-title='<%# grtt("resTooltipZoneName") %>'></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        function CheckData() {
            ...
            if ($('#<%=txtaArea.ClientID%>').val().replace(" ", "") == "") {
                $('#<%=txtaArea.ClientID%>').addClass("parsley-error")
                document.getElementById('ContentPlaceHolder1_lblMassage3').style.display = "";
                scrollAndFocus('#<%=txtaArea.ClientID%>');
                return;
            } else {
                $('#<%=txtaArea.ClientID%>').removeClass("parsley-error")
                document.getElementById('ContentPlaceHolder1_lblMassage3').style.display = "none";
            }
            if ($('#<%=txtaZoneName.ClientID%>').val().replace(" ", "") == "") {
                $('#<%=txtaZoneName.ClientID%>').addClass("parsley-error")
                document.getElementById('ContentPlaceHolder1_lblMassage2').style.display = "";
                scrollAndFocus('#<%=txtaZoneName.ClientID%>');
                return;
            } else {
                $('#<%=txtaZoneName.ClientID%>').removeClass("parsley-error")
